export default function Privacy() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6 text-foreground">Политика в отношении обработки персональных данных</h1>
      ...
      <div className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-foreground/80 prose-strong:text-foreground prose-li:text-foreground/80 prose-a:text-blue-600 prose-a:hover:underline dark:prose-a:text-blue-400">
        <section className="mb-8">
          ...
          <p className="mb-4">
            Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Юревич Дмитрий Станиславович (далее — Оператор).
          </p>
          <p className="mb-4">
            1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
          </p>
          <p>
            1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://finflexity.ru.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            ...
            <p><strong>2.3. Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://finflexity.ru.</p>
            ...
            <p><strong>2.8. Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://finflexity.ru.</p>
            ...
            <p><strong>2.10. Пользователь</strong> — любой посетитель веб-сайта https://finflexity.ru.</p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-medium mb-2">3.1. Оператор имеет право:</h3>
            ...
            <div>
              <h3 className="text-xl font-medium mb-2">3.2. Оператор обязан:</h3>
              <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-medium mb-2">4.1. Субъекты персональных данных имеют право:</h3>
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>выдвигать условие предварительного согласия при обработке персональных данных в целях продвижения на рынка товаров, работ и услуг;</li>
            ...
            <div>
              <h3 className="text-xl font-medium mb-2">4.2. Субъекты персональных данных обязаны:</h3>
              <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border border-foreground/20">
              <thead>
              <tr className="bg-foreground/5">
                <th className="border border-foreground/20 px-4 py-2 text-left">Цель обработки</th>
                <th className="border border-foreground/20 px-4 py-2 text-left">Персональные данные</th>
                <th className="border border-foreground/20 px-4 py-2 text-left">Правовые основания</th>
                <th className="border border-foreground/20 px-4 py-2 text-left">Виды обработки персональных данных</th>
              </tr>
              </thead>
              <tbody>
              <tr>
                <td className="border border-foreground/20 px-4 py-2">предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте</td>
                <td className="border border-foreground/20 px-4 py-2">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a href="mailto:d.s.yurevich@gmail.com">d.s.yurevich@gmail.com</a> с пометкой «Актуализация персональных данных».</p>
            ...
            <p>Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a href="mailto:d.s.yurevich@gmail.com">d.s.yurevich@gmail.com</a> с пометкой «Отзыв согласия на обработку персональных данных».</p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            <p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a href="mailto:d.s.yurevich@gmail.com">d.s.yurevich@gmail.com</a>.</p>
            ...
            <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://finflexity.ru/privacy">https://finflexity.ru/privacy</a>.</p>
          </div>
        </section>
        ...
        <div className="mt-8 p-4 bg-foreground/5 rounded-lg border border-foreground/10">
          ...
          <p className="text-sm text-foreground/60 mt-2">
            Настоящая версия Политики конфиденциальности действует с момента ее размещения на Сайте.
          </p>
        </div>
      </div>
    </div>
